  ...
  <div>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-dialog title="添加类目" :visible.sync="showCategoryDialog">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button @click="showCategoryDialog = false;CategoryName=''">取 消</el-button>
    ...
    methods: {
      ...
      renderContent(h, { node, data, store }) {
        return (
          ...
          <span>
          <el-button style="font-size: 12px;" type="text" disabled={data.notAdd}  on-click={ () => this.appendCategory(data) }>新增子类目</el-button>
          <el-button style="font-size: 12px;" type="text" on-click={ () => this.showUpdate(data) }>修改名称</el-button>
